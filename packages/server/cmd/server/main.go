...
func main() {
	...
	rest.Route(rules, authenticator, oauthhandler, adminhandler, userhandler, coursehandler, articlehandler, commenthandler,outlinehandler ,chapterhandler).Run(":8080")
